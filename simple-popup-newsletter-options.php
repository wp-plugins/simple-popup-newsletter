...
function simple_popup_newsletter_options() {
  ...
  '<form id="popup_box_options" name="popup_box_options" method="post" action="#"><table class="tbl_wrapper">';
    ...
    echo '<tr><td colspan="3"><br /></td></tr>';
    echo '<tr><td style="text-align: right; width: 400px;">Hide popup windows and allow my own submit forms like these codes below</td><td> : </td><td>'.
    '<input id="option_submit" name="option_submit" type="checkbox" '.$option.' value="1" /></td></tr>';
    echo '<tr><td colspan="3"><br />Subscribe HTML Form. (You can insert these in text widget for example.)<br /><textarea readonly="readonly" style="background-color: #FFFFFF; width: 700px; height: 170px;">'.$code1.'</textarea></td></tr>';
    echo '<tr><td colspan="3"><br />Unsubscribe HTML Form<br /><textarea readonly="readonly" style="background-color: #FFFFFF; width: 700px; height: 150px;">'.$code2.'</textarea></td></tr>';
