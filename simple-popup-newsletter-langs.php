...
function get_langwords() {
  ...
  $box_lang['option_label1'] = "Newsletter subscription! Add your email address and your name, than click subscription button.";
  $box_lang['option_label2'] = "Enter your email address for unsubscription.";
  $box_lang['option_name'] = "Your name:";
  $box_lang['option_email'] = "Email address:";
  $box_lang['option_button1'] = "Subscription";
  $box_lang['option_button2'] = "Unsubscription";
