...
function newsletter_menu_setup() {
  ...
  add_submenu_page('simple-popup-newsletter', 'Import', 'Import', 'manage_options', 'simple-popup-newsletter-import', 'simple_popup_newsletter_import'); 
}
...
<div style="float: left; margin: 5px 0px 0px 20px;"><input id="popup_box_all_checked" name="popup_box_all_checked" type="checkbox" value="1" style="margin-top: 0px;" /> - Check All Boxes</div>  
