...
Description: A popup window is for email subscription and unsubcriptions are also allowed by this components
Author: Varga Zsolt
...
<div class="popup-box-wrapper-unsub">
    ...
    <input type="hidden" id="unsubscribe_submit" name="unsubscribe_submit" value="1" />
		...
		<ul class="box-buttons">
		  <li><a href="#" id="box_unsub"><?php echo "".$label['option_button2']; ?></a></li>
		  <li><a href="#" id="box_exit_unsub"><?php echo "".$label['option_exit']; ?></a></li>
    </ul>
	</div>
</div>
<div class="popup-box-wrapper">
    ...
    <input type="hidden" id="subscribe_submit" name="subscribe_submit" value="1" />
		...
		<ul class="box-buttons">
		  <li><a href="#" id="box_sub"><?php echo "".$label['option_button1']; ?></a></li>
		  <li><a href="#" id="box_exit"><?php echo "".$label['option_exit']; ?></a></li>
    </ul>
	</div>
</div>
<?php
